...
public class Ex19 {
	public static void main(String[] args) {
		// Calendar 클래스
		// new 예약어와 생성자를 사용하지 않고 객체 생성하면서 현재 PC의 날짜와 시간 지정
		...
		// set 메소드로 날짜 설정하기  (월, 0-11)
		// now.set(2023, 11, 28);
		System.out.println(now.getTime());
		
		// 밀리초로 1970년 1월 1일 00시 00분 부터 흐른 시간 구하기
		System.out.println("1970년 1월 1일 0시 0분 부터 흐른 초 " + now.getTimeInMillis());
		...
		System.out.println(diff/(60*60*24*1000)); // 60*60*24*1 = 24시간(하루)
