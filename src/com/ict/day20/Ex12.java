...
// URL(Uniform Resource Locator) : 인터넷에서 접근 가능한 자원의 주소(위치)
	...
	//            final 클래스이다.(상속할 수 없다.) 
	// 
public class Ex12 {
	public static void main(String[] args) {
		InputStream is = null;
		InputStreamReader isr = null;
		BufferedReader br = null;                    // 저장할떄 쓰는 것 3줄
		
		// 내컴퓨터에 저장 
		String pathname = "D:/chulhwan/util/webpage01.txt";
		...
		try {
			...
			is = url.openStream(); // url 정보 가져올 수 있다. 
			...
			//System.out.println(sb.toString()); // toString 사용
